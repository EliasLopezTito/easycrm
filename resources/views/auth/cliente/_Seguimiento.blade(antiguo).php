            ...
            <div class="mt-20 pb-5">
                ...
                <div class="item">
                    ...
                    <div class="info-details">
                        <div>
                            <p class="info-details-title">{{ \easyCRM\App::formatDateStringSpanish($Cliente->created_at) }}</p>
                            <p>{{ $VendedorRegistrado->users->name. " ".$VendedorRegistrado->users->last_name }} creo este lead.</p>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="auth/js/cliente/_Seguimiento.min.js"></script>
