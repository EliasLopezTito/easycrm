...
class ReporteController extends Controller
{
    ...
    public function filtro(Request $request)
    {
        ...
        if ($userLogin->id == 1) {
            ...
            $totalClientesMatriculasRonald = $this->obtenerTotalClienteMatriculasCreadosPorFecha($userProfile, "2025-03-02", "2025-03-02", "created_at_last_contact");
            //
            ...
            dd($EstadosRonald, $totalClientesRonald, $arregloFilterEstadosGlobalRonald, $arregloFilterEstadosRonald, $totalClientesMatriculasRonald->count());
        }
