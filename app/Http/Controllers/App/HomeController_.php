...
class HomeController extends Controller
{
    ...
    public function make(Request $request)
    {
        try {
            ...
            if($request->get('FormId') == "4947790538635226"){ //ENFERMERIA
                $Carrera = Carrera::where('id', 1)->first();
            }else if($request->get('FormId') == "519452256273248"){ //FARMACIA
                $Carrera = Carrera::where('id', 2)->first();
            }else if($request->get('FormId') == "905249356813296"){ //FISIOTERAPIA
                $Carrera = Carrera::where('id', 3)->first();
            }else if($request->get('FormId') == "1436460133487427"){ //LABORATORIO
                $Carrera = Carrera::where('id', 4)->first();
            }else if($request->get('FormId') == "452648633406155"){ //PROTESIS DENTAL
