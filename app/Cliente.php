...
class Cliente extends Model
{
    ...
    protected $fillable = [
        'user_id', 'nombres', 'apellidos', 'apellido_paterno', 'apellido_materno', 'dni', 'celular', 'whatsapp', 'email', 'fecha_nacimiento', 'proviene_id', 'provincia', 'provincia_id', 'distrito_id', 'direccion',
        ...
        'presencial_horario_id', 'tipo_operacion_id', 'nro_operacion', 'monto', 'nombre_titular', 'codigo_alumno', 'promocion', 'observacion', 'ultimo_contacto', 'created_modified_by', 'origen_lead'
    ];
